...
interface IRegistry {
    function refreshCredits() external;
}

contract APICredsRefresh is FunctionsClient, ConfirmedOwner, ERC721URIStorage {

    address owner;

     constructor(address _owner) FunctionsClient(router) ConfirmedOwner(msg.sender) ERC721("Poster Ad", "PAd") {
        owner = _owner;
     }
