...
export default function Landing(){
    ...
    <div className="w-full h-max-screen">
        ...
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">GreenWim</span>
        </a>

        <div className="  ">
        <Link href="/sale">
        <button type="button" className="text-white  focus:outline-none focus:ring-blue-300 font-medium rounded-xl   text-md  py-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 p-12">Launch App</button> 
        </Link>  
        </div>
        </div>
        </nav>
        ...
        <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Transform<mark className=" ml-2 px-2 text-white bg-emerald-600 rounded-full dark:bg-emerald-500">Energy</mark> Into Impact .</h1>
    ...
    <img className="w-2/4 h-auto  rounded-lg" src="https://www.tickertape.in/blog/wp-content/uploads/2022/11/28-Oct-22-solar-energy-stocks-in-india_-.png" alt="image" />
    </div>
    <div className="-mt-40 ml-96 gap-3 w-2/3 flex justify-center">
    <img className="w-2/3 h-auto max-w-2xl rounded-lg" src="https://www.tickertape.in/blog/wp-content/uploads/2022/11/02-Nov-22-Green-Energy-Stocks-15.png" alt="image" />
    </div>
    </div>
    </div>
    </div>
    ...
    <div className="w-full mt-16 ml-20 flex flex-row">
      <div className="w-1/2">  
      <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Generate Revenue</span> With GreenWim.</h1>
      <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 mr-28">it creates a market for renewable energy, encouraging investment and innovation in the sector.</p>
      </div>
      <div className="mr-20 w-1/2">
      <h2 className="  text-5xl font-semibold dark:text-white">We strive to protect nature for future generations</h2>
      ...
      <img className="h-auto max-w-md  transition-all duration-300 rounded-2xl border hover:border-none hover:blur-none" src="https://www.nationalgrid.com/sites/default/files/images/EnergyExplained_DifferentTypesRenewableEnergy_640x360.jpg" alt="image description" />

      
      <img className="h-auto max-w-md transition-all duration-300 rounded-2xl border hover:border-none  hover:blur-none" src="https://assets.justenergy.com/wp-content/uploads/2019/02/Green-energy-what-is-it-all-about-greenenergy-image-1.jpg" alt="image description" />

      
      <img className="h-auto max-w-lg transition-all duration-300 rounded-2xl border hover:border-none  hover:blur-none" src="https://www.concordia.ca/cunews/offices/advancement/2022/10/24/renewable-revolution/_jcr_content/parsys/image.img.jpg/1666391011564.jpg" alt="image description" />
      ...
      <div className="w-full flex ">  
        <h1 className="text-7xl  mt-32 font-semibold font-roboto ml-32 text-transparent bg-clip-text bg-gradient-to-r to-emerald-500 from-sky-400">Green</h1>
        <div className="border-2 rounded-full w-96 h-96 ml-64 mt-10">
        <img className=" rounded-full border-2 w-96 h-96" src="https://4kwallpapers.com/images/wallpapers/green-leaves-plant-aesthetic-5k-2732x2732-3559.jpg" alt="image description" />
        </div>
