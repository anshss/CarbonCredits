        ...
        <div class="px-5 pb-5">
          <div class=" items-center justify-between">
            <button
              ...
              className="text-white bg-yellow-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-md px-20 py-2 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-blue-800"
            >
              Buy
            </button>
